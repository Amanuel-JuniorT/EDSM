...
import { useStocksStore } from "../store/useStocksStore"; // Assuming this is defined in your store
...
//     description: "Ethio Telecom is the largest telecom provider in Ethiopia.",
//   },
//   {
//     symbol: "ETHBANK",
...
//     marketCap: "ETB 8.9B",
//     description:
//       "Ethiopian Sugar Corporation is a major sugar producer in Ethiopia.",
//   },
//   {
//     symbol: "ETHBANK2",
//     name: "Dashen Bank",
...
//     change: "+2.5%",
//     marketCap: "ETB 18.7B",
//     description: "Dashen Bank is one of the largest private banks in Ethiopia.",
//   },
//   {
//     symbol: "ETHMIN",
...
//     marketCap: "ETB 15.6B",
//     description:
//       "Ethiopian Mining Corporation is a leading mining company in Ethiopia.",
//   },
//   {
//     symbol: "ETHOIL",
...
//     change: "+1.2%",
//     marketCap: "ETB 20.1B",
//     description: "Ethiopian Oil & Gas is a major player in the energy sector.",
//   },
//   {
//     symbol: "ETHAGR",
...
//     change: "-0.8%",
//     marketCap: "ETB 10.2B",
//     description: "Ethiopian Agriculture is a key agricultural company.",
//   },
//   {
//     symbol: "ETHFOOD",
...
//     change: "+0.5%",
//     marketCap: "ETB 5.3B",
//     description: "Ethiopian Food Processing is a major food producer.",
//   },
//   {
//     symbol: "ETHPHAR",
...
//     change: "-2.2%",
//     marketCap: "ETB 7.8B",
//     description: "Ethiopian Pharmaceuticals is a leading pharma company.",
//   },
//   {
//     symbol: "ETHEM",
...
//     change: "+4.1%",
//     marketCap: "ETB 6.2B",
//     description: "Ethiopian Cement is a major cement producer.",
//   },
//   {
//     symbol: "ETHCON",
...
//     change: "+0.0%",
//     marketCap: "ETB 9.5B",
//     description: "Ethiopian Construction is a leading construction company.",
//   },
// ];

const news = [
  {
    title: "Ethiopian Airlines Expands Fleet",
    date: "2024-06-01",
    url: "#",
    summary:
      "Ethiopian Airlines has announced the addition of 5 new aircraft to its fleet.",
  },
  {
    title: "Ethio Telecom Launches 5G",
    date: "2024-05-28",
    url: "#",
    summary: "Ethio Telecom has launched 5G services in Addis Ababa.",
  },
  {
    title: "CBE Reports Record Profits",
    date: "2024-05-25",
    url: "#",
    summary: "Commercial Bank of Ethiopia reports record profits for Q1 2024.",
  },
];
...
function BuySellWidget({ stock }) {
  ...
  React.useEffect(() => {
    setCost((shares > 0 ? shares : 0) * stock?.unitPrice);
  ...
  const handleBuy = async () => {
    await getBalance(); // Ensure balance is up-to-date
    // Check if balance can buy stock
    if (balance === null) {
    ...
    if (cost > balance) {
      toast.error("Insufficient balance to buy this stock.");
      return;
    }
    ...
    >
      ...
      >
        <button
          ...
          style={{
            ...
            fontWeight: 700,
            fontSize: "1.13em",
            color: tab === "buy" ? "var(--primary-color)" : "var(--text-muted)",
            borderBottom:
              tab === "buy"
        ...
        <button
          ...
          style={{
            ...
            fontSize: "1.13em",
            color:
              tab === "sell" ? "var(--primary-color)" : "var(--text-muted)",
            borderBottom:
              tab === "sell"
                ? "2.5px solid var(--primary-color)"
                : "2.5px solid transparent",
      ...
      >
        ...
        <span style={{ color: "var(--primary-color)", fontWeight: 700 }}>
          ETB {cost?.toLocaleString(undefined, { minimumFractionDigits: 2 })}
        </span>
      </div>
      <button
        ...
        style={{
          ...
          cursor: (tab === "sell" ? canSell : shares >= 1)
            ? "pointer"
            : "not-allowed",
      ...
      >
        ...
        >
          {isLoadingBalance || isBuyingStock ? (
...
export default function StockDetail() {
    ...
    return (
      <div className="stock-detail-page">
        ...
        >
          ...
          <p>
            The stock symbol <b>{symbol}</b> does not exist.
          </p>
          <button
  ...
  return (
    <div
      ...
      style={{ maxWidth: 1100, margin: "0 auto", padding: "2.5rem 0 2.5rem 0" }}
    >
      <div
        style={{
          display: "flex",
          gap: 16,
          marginBottom: fromDashboard || fromMarket ? 24 : 0,
        }}
      >
        {fromDashboard && (
          <button
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {stock?.industry} &middot; {stock?.sector}
              </div>
            </div>
          </div>
          {/* Price & Change */}
          ...
          >
            ...
            >
              ETB {stock?.unitPrice.toLocaleString()}
            </div>
            <div
              style={{
                fontWeight: 600,
                fontSize: "1.2rem",
                color: stock?.change.toString().startsWith("+")
                  ? "var(--success-color)"
                  : "var(--danger-color)",
                display: "flex",
                alignItems: "center",
            ...
            >
              <i
                className={`fas fa-arrow-${
                  stock?.change.toString().startsWith("+") ? "up" : "down"
                }`}
              ></i>{" "}
              {stock?.change}
            </div>
          ...
          >
            ...
            <img
              src="https://placehold.co/600x180/1976d2/fff?text=Chart+Coming+Soon"
              alt="Chart"
          ...
          >
            <div
              style={{ flex: 2, minWidth: 320, padding: "28px 28px 20px 28px" }}
            >
              <div
                style={{
                  fontWeight: 600,
              ...
              <div
                style={{ fontSize: "0.98rem", color: "#666", marginBottom: 6 }}
              >
                <span style={{ fontWeight: 500 }}>CEO:</span> {stock?.ceo}{" "}
                &middot; <span style={{ fontWeight: 500 }}>Employees:</span>{" "}
                {stock?.employees}
              </div>
              <div
                style={{ fontSize: "0.98rem", color: "#666", marginBottom: 6 }}
              >
                <span style={{ fontWeight: 500 }}>Headquarters:</span>{" "}
                {stock?.headquarters}
              </div>
              <div
                style={{ fontSize: "0.98rem", color: "#666", marginBottom: 6 }}
            ...
            />
            <div
              style={{ flex: 1, minWidth: 260, padding: "28px 28px 20px 28px" }}
            >
              <div
                style={{
                  fontWeight: 600,
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {news.map((n, i) => (
                  <li key={i} style={{ marginBottom: 16 }}>
                    ...
                    <div style={{ color: "#888", fontSize: "0.93rem" }}>
                      {n.date}
                    </div>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
              {related.map((r, i) => (
                ...
                >
                  <div style={{ fontSize: "1.08rem", marginBottom: 2 }}>
                    {r.name}
                  </div>
