...
//     summary:
//       "A new company is going public on EDSM. Find out how you can participate...",
//     image:
...
//     summary:
//       "Tech companies are driving the market rally, with ETHIT and ETHCOM up double digits...",
//     image:
...
export default function Dashboard() {
  ...
  const { getBalance, balance, updateBalance, isLoadingBalance } =
    useProfileStore();
    ...
    >
      ...
      <div className="dashboard-header">
        <div className="dashboard-header-left">
          <h1>
            Welcome back, {user.firstName} <span className="wave">👋</span>
          </h1>
          <div className="dashboard-subtitle">
            Here is your overview of your investments.
          </div>
        </div>
      ...
      <div className="dashboard-summary-cards">
        <div className="summary-card">
          ...
          <div className="summary-value">ETB </div>
        </div>
        <div className="summary-card">
          <div className="summary-title">Daily Gain/Loss</div>
          <div className="summary-value positive">
            <i className="fas fa-arrow-up"></i> 2.23%
          </div>
        </div>
        <div className="summary-card">
      ...
      <div className="dashboard-actions-row">
        <div className="card quick-action-card">
          ...
          <div className="quick-actions">
            ...
            >
              <i className="fas fa-bolt"></i> Buy Stock
            </button>
            <button
              className="btn btn-add-fund"
              id="quick-add-fund"
              onClick={() => setShowAddFund(true)}
            >
              <i className="fas fa-download"></i> Add Fund
            </button>
            <button
              className="btn btn-outline"
              id="quick-view-watchlist"
              onClick={() =>
                navigate("/watchlist", { state: { fromDashboard: true } })
              }
            >
              <i className="fas fa-bookmark"></i> View Watchlist
            </button>
            <button
              className="btn btn-outline"
              id="quick-search"
                ...
                <tbody>
                  {marketFeed.map((row, idx) => (
                    ...
                    >
                      ...
                      <td
                        className={
                          row.change.startsWith("+") ? "positive" : "negative"
                        }
                      >
                        {row.change}
                      </td>
